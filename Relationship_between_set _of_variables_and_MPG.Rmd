...
#### Analysis
First scatter plot was created to see relationship between all of the vaariables to each other, see Figure 1.1. Which showed there is releationship between variables and MPG and to narrow down analysis box plot is created with only subset of data focusing on transmision types. See Figure 1.2. The box plot clearly showed that there was a difference in MPG depending on transmission type. Automobiles with a manual transmission had a higher MPG than those with an automatic.
